...
//! This crate provides deserialize for GraphQL configs following the
//! [graphql-config](https://github.com/prismagraphql/graphql-config/blob/master/specification.md) specification.
